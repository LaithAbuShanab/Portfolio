                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('update.blog')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" value="{{$blogs->blog_title}}" id="blog_title" name="blog_title" type="text">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" value="{{$blogs->blog_tags}}" id="blog_tags" value="home,tech" name="blog_tags" type="text" data-role="tagsinput">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="blog_description" id="elm1">{{$blogs->blog_description}}</textarea>
                                </div>
                            </div>
