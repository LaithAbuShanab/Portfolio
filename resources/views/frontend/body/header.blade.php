                        ...
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="{{ ($active == 'home.about') ? 'active' : '' }}"><a href="{{route('home.about')}}">About</a></li>
                                    <li class="{{ ($active == 'home.about') ? 'active' : '' }}"><a href="services-details.html">Services</a></li>
                                    <li class="{{ ($active == 'home.portfolio') ? 'active' : '' }}"><a href="{{route('home.portfolio')}}">Portfolio</a></li>
                                    <li class="{{ ($active == 'home.blog') ? 'active' : '' }}"><a href="{{route('home.blog')}}">Our Blog</a></li>
                                    <li class="{{ ($active == 'contact.me') ? 'active' : '' }}"><a href="{{route('contact.me')}}">contact me</a></li>
                                </ul>
                            </div>
